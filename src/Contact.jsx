...
export default function Contact({ dark }) {
  function Socials() {
    return (
      <div className="Socials flex flex-col gap-6">
        <div className="phone-holder flex flex-row gap-6">
          <div className="phone-img">
            <img src={dark ? mobileLight : mobile} alt="phone" />
          </div>
          <div>+25146410664</div>
        </div>
        <div className="email-holder flex flex-row gap-6">
          <div className="email-img">
            <img src={dark ? emailLight : email} alt="email" />
          </div>
          <div>mohammedibrahim4641@gmail.com</div>
        </div>
        <div className="social-holder flex flex-row gap-4">
          <div>
  ...
  function Form() {
    ...
    return (
      <form
        ref={form}
        onSubmit={sendEmail}
        className="form-holder flex flex-col gap-6 mt-16"
      >
        <input
          type="text"
          name="name"
  ...
  return (
    <div className="Contact flex flex-col justify-between md:mx-16 md:my-32 max-md:mt-24 max-md:mx-6">
      <div className="about-header flex flex-row gap-6 md:justify-end md:my-16 max-md:my-6">
      ...
      <div className="content-holder-contact flex flex-row justify-between mt-16">
